...
describe('product portfolio', () => {
  ...
  it('uses a parent-brand homepage, not a fifth product sales page', () => {
    ...
    assert.match(home, /Four products. One company/)
    assert.match(home, /Why four/)
    assert.match(home, /How to start/)
    assert.match(home, /The company/)
    assert.match(home, /Repave/)
    assert.match(home, /Overpass/)
    assert.match(home, /Toll/)
    assert.match(home, /Dispatch/)
    assert.match(home, /repave.opsdevco.de/)
    assert.match(home, /overpass.opsdevco.de/)
    assert.match(home, /toll.opsdevco.de/)
    assert.match(home, /dispatch.opsdevco.de/)
