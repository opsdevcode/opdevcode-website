...
export const products: Product[] = [
  ...
  },
  {
    ...
    summary:
      'Keep infrastructure state readable — inventory, dependency, and gated change — without treating live cloud drift as a software-delivery problem.',
    body: [
      ...
      'Those state capabilities are in development. Hosted state custody is off by default and enabled per early-access partner. Overpass is not a delivery product, not an economics product, and not generally available.',
    ],
    owns: [
      'Terraform and OpenTofu state custody',
      'Infrastructure inventory and resource relationships',
      'Blast radius from a proposed or live change',
      'Drift against declared infrastructure',
  ...
  },
  {
    ...
    body: [
      ...
      'Those economics capabilities are in development. Hosted cost periods are off by default. Toll does not invoice, warehouse billing extracts, execute purchases, or claim savings percentages. A human buys commitments.',
    ],
    owns: [
      'Spend attribution at resource grain',
      'Ownership and catalog correlation',
      'Utilization evidence',
      'Waste findings as evidence',
      'Commitment coverage as evidence',
      'Period capture for early-access enablement',
    ],
    doesNot: [
  ...
  },
  {
    ...
    body: [
      'Dispatch owns the governed interaction: intent to proposal to allowed action, under Advisory, Supervisory, and Autonomous trust modes. It consumes Repave, Overpass, and Toll; those products remain authoritative. It is not a fourth data domain.',
      'The architecture and trust model are defined. Dispatch never evaluates its own policy, invents evidence, or approves its own work. Today, agent execution on Repave is limited primarily to generate. Broader cross-domain action is not a current hosted path.',
    ],
    owns: [
      'Intent capture into a proposal',
      'Trust-ladder policy of use',
      'Routing to domain products without taking their stores',
      'Evidence-bound action where a domain product allows it',
      'Refusal when policy or evidence is missing',
      'A single interaction surface across the four jobs',
    ],
    doesNot: [
